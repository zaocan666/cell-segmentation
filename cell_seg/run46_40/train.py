...
def train_net(net,
    ...
    for epoch in range(epochs):
        ...
        torch.save(net.state_dict(),
                   dir_checkpoint + f'val {val_i}_CP_epoch{epoch + 1}_score_%.4f.pth'%(val_score))
    ...
    if save_cp:
        torch.save(best_net.state_dict(),
                   dir_checkpoint + f'val {val_i}_best_CP_epoch{best_e + 1}_score_%.4f_jaccard_%.4f.pth'%(best_score,jaccard_vali))
