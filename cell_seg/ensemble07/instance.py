...
def instancing_water2(pred_bi, dis_thres, max_dil_size, vis_flag=False):
	...
	if vis_flag:
		...
		ax2.imshow(markers_lab, cmap=plt.cm.Spectral, interpolation='nearest')
		ax2.set_title("Markers")
		ax3.imshow(labels_left, cmap=plt.cm.Spectral, interpolation='nearest')
		ax3.set_title("Segmented left")
		ax4.imshow(labels, cmap=plt.cm.Spectral, interpolation='nearest')
		ax4.set_title("Segmented all")
...
def instancing(pred_bi, dis_thres=13, max_dil_size=8, vis_flag=False):
	pred_bi = np.array(pred_bi, np.uint8)
	return instancing_water2(pred_bi, dis_thres, max_dil_size, vis_flag)
